...
#if LV_USE_LABEL
    #define LV_LABEL_TEXT_SELECTION 0 /* 禁用标签文本选择功能 */
    #define LV_LABEL_LONG_TXT_HINT 0  /* 禁用标签中存储一些额外信息，以加快超长文本的绘制速度 */
    #define LV_LABEL_WAIT_CHAR_COUNT 0  /* 禁用等待字符的数量 */
#endif
